...
const Flavours = () => {
  ...
  <div>
    ...
    <div className="mt-10 text-center w-4/5 mx-auto">
      ...
      <div className="mt-10">
      <button className="btn btn-outline bg-slate-950 hover:bg-[#eb5058] text-white font-bold uppercase hover:border-pink-600">
      Read More
    </button>
      </div>
    </div>
